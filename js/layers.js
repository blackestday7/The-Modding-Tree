addLayer("a", {
    name: "attention", // This is optional, only used in a few places, If absent it just uses the layer id.
    ...
    resource: "Attention", // Name of prestige currency
...
addLayer("p", {
    ...
    row: 0, // Row the layer is in on the tree (0 is the first row)
    hotkeys: [
        {key: "p", description: "P: Reset for Cats", onPress(){if (canReset(this.layer)) doReset(this.layer)}},
    ],
    layerShown(){return true},
})